...
public abstract class Texture extends GraphicsResource
{
     ...
     * <p>
     * For example, this value is used by {@link SpriteBatch} when drawing with
     * {@link SpriteSortMode#Texture}.
     * <p>
     * The value is an implementation detail and may change between application launches or MonoGame
     * versions. It is only guaranteed to stay consistent during application lifetime.
     * 
    ...
    // TODO(Eric): I added this array to hold the image data
    // TODO(Eric): This is handled by ShaprDX and I don't know how it works yet.
