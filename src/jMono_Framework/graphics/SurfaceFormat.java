...
// TODO(Eric): Constructor and values
/**
...
public enum SurfaceFormat
{
    ...
    Dxt5, // = 6
    /**
     * Signed 16-bit bump-map format for store 8 bits for {@code u} and {@code v} data.
     */
    NormalizedByte2,
    /**
    ...
    // TODO(Eric): Add constructor for the specific values

    // NOTE(Eric): This method is from the file GraphicsExtension.cs
    public boolean isCompressedFormat()
    {
        switch (this)
        {
            ...
            case Dxt5:
            case Dxt5SRgb:
            case RgbaAtcExplicitAlpha:
            case RgbaAtcInterpolatedAlpha:
            case RgbaPvrtc2Bpp:
            case RgbaPvrtc4Bpp:
            case RgbEtc1:
            case RgbPvrtc2Bpp:
    ...
    // NOTE(Eric): This is to convert the data read from the disk into an enum value
