...
public class RenderTargetBinding
{
    ...
    protected DepthFormat getDepthFormat()
    {
        return _depthFormat;
    }
        
    // TODO(Eric): Since this is a struct, should I add a no-arguments constructor ?
    public RenderTargetBinding(RenderTarget2D renderTarget)
    {
        ...
        _depthFormat = renderTarget.getDepthStencilFormat();
    }
...
// #if DIRECTX
    ...
    // throw new
    // IllegalArgumentException("Texture arrays are not supported on this graphics device");
    //
    // _renderTarget = renderTarget;
