 ...
 *
 */
public class Vector3 // implements IEquatable<Vector3>
{
    ...
    /**
     * Returns a {@link Vector3} with components 0, 0, 0.
     * 
    ...
    /**
     * Returns a {@link Vector3} with components 1, 1, 1.
     * 
    ...
    /**
     * Returns a {@link Vector3} with components 1, 0, 0.
     * 
    ...
    /**
     * Returns a {@link Vector3} with components 0, 1, 0.
     * 
    ...
    /**
     * Returns a {@link Vector3} with components 0, 0, 1.
     * 
    ...
    /**
     * Creates a new {@code Vector3} that contains the cartesian coordinates of a vector specified
     * in barycentric coordinates and relative to 3d-triangle.
     * 
     * @param value1
     ...
     *        {@code Vector3} of 3d-triangle.
     * @param amount2
     *        Barycentric scalar {@code b3} which represents a weighting factor towards third
     *        {@code Vector3} of 3d-triangle.
     ...
     */
    public static void barycentric(final Vector3 value1, final Vector3 value2, final Vector3 value3,
                                   float amount1, float amount2, Vector3 result)
    {
    ...
    /**
     * Creates a new {@code Vector3} that contains CatmullRom interpolation of the specified
     * vectors.
     * 
     * @param value1
    ...
    /**
     * Creates a new {@link Vector3} that contains linear interpolation of the specified vectors.
     * 
     * @param value1
     *        The first {@code Vector3}.
     * @param value2
    ...
    // Less efficient but more precise compared to {@link Vector3#lerp}(Vector3, Vector3, float)"/>.
    ...
    // Creates a new {@link Vector3} that contains linear interpolation of the specified vectors.
    // Uses {@link MathHelper#lerpPrecise} on MathHelper for the interpolation.
    // Less efficient but more precise compared to {@link Vector3#lerp}(ref Vector3, ref Vector3, float, out Vector3)"/>.
    // See remarks section of {@link MathHelper#lerpPrecise} on MathHelper for more info.
    // </summary>
    // <param name="value1">The first vector.</param>
    // <param name="value2">The second vector.</param>
    ...
    public static void lerpPrecise(final Vector3 value1, final Vector3 value2, float amount, Vector3 result)
    {
    ...
    /**
     * Stores a {@code Vector3} pointing in the opposite direction of {@code value} in
     * {@code result}.
     * 
     * @param value
    ...
    /**
     * Creates a new {@code Vector3} that contains a transformation of 3d-vector by the specified
     * {@link Matrix}.
     * 
     * @param position
     *        Source {@code Vector3}.
    ...
    /**
     * Apply transformation on vectors within array of {@code Vector3} by the specified
     ...
     *        The starting index in the destination array, where the first {@code Vector3} should be
     *        written.
     * @param length
    ...
    /**
     * Apply transformation on all vectors within array of {@code Vector3} by the specified
     * {@link Matrix} and places the results in an another array.
     * 
     * @param sourceArray
     *        Source array.
    ...
    /**
     * Creates a new {@code Vector3} that contains a transformation of the specified normal by the
    ...
    /**
     * Apply transformation on normals within array of {@code Vector3} by the specified
     * {@link Matrix} and places the results in an another array.
     * 
     * @param sourceArray
     *        Source array.
    ...
    /**
     * Apply transformation on all normals within array of {@code Vector3} by the specified
     * {@link Matrix} and places the results in an another array.
     * 
     * @param sourceArray
     *        Source array.
    ...
    /**
     * Multiplies the components of this {@code Vector3} by the components of the supplied
     * {@code Vector3}.
     * 
     * @param other
    ...
    /**
     * Divides the components of this {@code Vector3} by the components of the supplied
     * {@code Vector3}.
     * 
     * @param other
