...
public class BoundingBox
{
	...
	public ContainmentType contains(BoundingFrustum frustum)
	{
		...
		int i;
		ContainmentType contained = ContainmentType.Disjoint; // TODO: should we set it to null ?
		...
		if (i == corners.length)	// This means we checked all the corners and they were all contain
									// or instersect
			return ContainmentType.Contains;
		...
		// the frustum.
		// So we assume that all other points will also be contained. If one of the points is
		// disjoint, we can
		...
		// If we get here, then we know all the points were actually contained, therefore result is
		// Contains
		return ContainmentType.Contains;
	}
	...
	{
		ContainmentType result = ContainmentType.Disjoint; // TODO: should we set it to null ?
	...
	private static Vector3 MAX_VECTOR3() { return new Vector3(MaxVector3); }
	private static Vector3 MIN_VECTOR3() { return new Vector3(MinVector3); }

	// / <summary>
	// / Create a bounding box from the given list of points.
	// / </summary>
	// / <param name="points">The list of Vector3 instances defining the point cloud to
	// bound</param>
	// / <returns>A bounding box that encapsulates the given point cloud.</returns>
	// / <exception cref="System.ArgumentException">Thrown if the given list has no
	// points.</exception>
	...
	public void intersects(final Plane plane, PlaneIntersectionType result)
	{
		...
		// Inline float distance = Vector3.dot(plane.normal, negativeVertex) + plane.D;
		...
		// Inline distance = Vector3.dot(plane.normal, positiveVertex) + plane.D;
