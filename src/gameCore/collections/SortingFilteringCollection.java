...
public class SortingFilteringCollection<T> implements Collection<T> {
	...
	public boolean remove(Object item) {
		if (_addJournal.remove(createKey((T) item))) return true;
	...
	private void processRemoveJournal() {
		if (_removeJournal.size() == 0) return;
	...
	//private BiConsumer<Object, Object> item_FilterPropertyChanged = (sender, e) -> invalidateCache();
	private void item_FilterPropertyChanged(Object sender, EventArgs e) {
		invalidateCache();
	}
	
	// private BiConsumer<Object, Object> Item_SortPropertyChanged = (sender, e) -> Item_SortPropertyChanged(sender, e);
	...
	private class AddJournalEntry<E> {
		...
		public boolean equals(Object obj) {
			if (!(obj instanceof AddJournalEntry)) return false;
